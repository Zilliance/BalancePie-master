...
class OnboardingPopover: UIView {
    ...
    fileprivate func commonInit() {
        ...
        self.roundedRectView.backgroundColor = .lightBlueBackground
        ...
        self.arrowView.backgroundColor = .lightBlueBackground
    ...
    func present(in view: UIView, at point: CGPoint, from direction: Direction, prePresenter: (()->Void)?=nil, animator: (()->Void)?=nil) {
    ...
    func dismiss(_ animator: (()->Void)?=nil) {
    ...
    func setFrame(in view: UIView, at point: CGPoint, from direction: Direction) {
